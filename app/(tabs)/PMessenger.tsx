        ...
        const list = Object.keys(data)
          .map((uid) => {
            ...
            return {
              ...
              role: isAdmin ? "admin" : data[uid].role || "personnel",
              fullName:
                data[uid].fullName ||
                data[uid].username ||
                (data[uid].firstName
          ...
          .filter(
            (u) =>
              u.uid !== cu.uid &&
              ["admin", "personnel", "tech", "user"].includes(u.role),
          );
        list.sort((a, b) =>
        ...
        >
          ...
          >
            ...
            <TextInput
              ...
              style={[
                mono,
                { flex: 1, marginLeft: 8, fontSize: 15, color: C.text },
              ]}
              ...
              return (
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    borderColor: C.border,
                    borderLeftWidth: 3,
                    borderLeftColor: unread > 0 ? C.maroon : C.mutedLight,
                    borderRadius: 4,
                    marginBottom: 8,
                    flexDirection: "row",
                    alignItems: "center",
